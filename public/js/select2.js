var Select2 = {
    init: function () {
        $("#m_select2_1, #m_select2_1_validate").select2({placeholder: "Select"}), $("#m_select2_2, #m_select2_2_validate").select2({placeholder: "Select"}), $("#m_select2_3, #m_select2_3_validate").select2({placeholder: "Select"}), $("#m_select2_4").select2({
