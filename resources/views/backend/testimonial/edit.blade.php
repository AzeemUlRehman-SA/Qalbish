    ...
    <div class="m-content">
        <div class="m-portlet m-portlet--mobile">
            ...
            <div class="m-portlet__body">
                <div class="col-lg-12">
                    <div class="m-portlet">
                        <form class="m-form" method="post" action="{{ route('admin.testimonial.update',$testimonial->id) }}"
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <textarea id="description" type="text"
                                                      ...
                                                      name="description"
                                                      autocomplete="description">{{ $testimonial->description }}</textarea>
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <input value="{{ $testimonial->image }}" type="file"
                                            ...
                                            <img width="300" height="200" class="img-thumbnail"
                                                 style="display:{{($testimonial->image) ? 'block' : 'none'}};"
                                                 id="img"
