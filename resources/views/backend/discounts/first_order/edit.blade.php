                ...
                <div class="col-lg-12">
                    <div class="m-portlet">
                        <form class="m-form" method="post"
                              action="{{ route('admin.first-order-discount.update', $first_order_discount->id) }}"
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <select id="type"
                                                ...
                                                <option
                                                    value="fixed" {{ ($first_order_discount->type == 'fixed') ? 'selected' :'' }}>
                                                    Fixed
                                                </option>
                                                <option
                                                    value="percentage" {{ $first_order_discount->type == 'percentage' ? 'selected' :'' }}>
                                                    Percentage
                                                </option>
                                            </select>
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <input id="price" type="number"
                                                   ...
                                                   value="{{ ($first_order_discount->type == 'fixed') ? $first_order_discount->value : $first_order_discount->percent_off  }}"
