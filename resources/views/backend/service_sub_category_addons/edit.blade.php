                ...
                <div class="col-lg-12">
                    <div class="m-portlet">
                        <form class="m-form" method="post"
                              action="{{ route('admin.addons.update', $service_sub_category_addon->id) }}"
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <input id="name" type="text"
                                                   ...
                                                   name="name" value="{{ $service_sub_category_addon->name }}"
                                        ...
                                        <div class="col-md-6">
                                            <label for="slug"
                                                   class="col-md-4 col-form-label text-md-left">{{ __('Slug') }}</label>
                                            <input id="slug" type="text"
                                                   class="form-control @error('slug') is-invalid @enderror"
                                                   name="slug" value="{{ $service_sub_category_addon->slug }}"
                                            ...
                                            <select id="service_id"
                                                ...
                                                @if(!empty($categories))
                                                    @foreach($categories as $category)
                                                        <option
                                                            value="{{$category->id}}" {{ ($category->id == $service_sub_category_addon->category_id) ? 'selected' : '' }}>{{ucfirst($category->name)}}</option>
                                                    @endforeach
                                                @endif
                                            </select>
                                            ...
                                            <select id="service_category_id"
                                                ...
                                                @if(!empty($services))
                                                    @foreach($services as $service)
                                                        <option
                                                            value="{{$service->id}}" {{ ($service->id == $service_sub_category_addon->service_category_id) ? 'selected' : '' }}>{{ucfirst($service->name)}}</option>
                                                    @endforeach
                                                @endif
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-6">
                                            <label for="service_sub_category_id"
                                                   class="col-md-4 col-form-label text-md-left">{{ __('Menu Item') }}</label>
                                            ...
                                            <select id="service_sub_category_id"
                                                ...
                                                @if(!empty($service_sub_categories))
                                                    @foreach($service_sub_categories as $service_sub_category)
                                                        <option
                                                            value="{{$service_sub_category->id}}" {{ ($service_sub_category_addon->service_sub_category_id == $service_sub_category->id) ? 'selected' : ''}}>{{$service_sub_category->name}}</option>
                                                    @endforeach
                                                @endif
                                            </select>
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <input id="price" type="number"
                                                   ...
                                                   name="price" value="{{ $service_sub_category_addon->price }}"
