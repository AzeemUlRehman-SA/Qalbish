                ...
                <div class="col-lg-12">
                    <div class="m-portlet">
                        <form class="m-form" method="post"
                              action="{{ route('admin.meta-tags.update', $meta_tags->id) }}"
                                    ...
                                    <div class="form-group row">
                                        <div class="col-md-4">
                                            ...
                                            <input id="route" type="text"
                                                   ...
                                                   name="route" value="{{ $meta_tags->route }}"
                                                   autocomplete="route" autofocus readonly>
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <input id="title" type="text"
                                                   ...
                                                   name="title" value="{{ $meta_tags->title }}"
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <input id="keywords" type="text"
                                                   ...
                                                   name="keywords" value="{{ $meta_tags->keywords }}"
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-12">
                                            ...
                                            <textarea name="description" id="description"
                                                      ...
                                                      rows="10"
                                                      cols="80">{{ $meta_tags->description }}</textarea>
