                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                                            <div class="form-group">
                                                                ...
                                                                <select class="form-control cities disabledDiv"
                                                                        name="city_id"
                                                                        id="city_id">
                                                        ...
                                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                                            <div class="form-group">
                                                                ...
                                                                <select class="form-control areas disabledDiv"
                                                                        id="area_id"
                                                                        name="area_id">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                                            <div class="form-group">
                                                                ...
                                                                <select class="form-control disabledDiv" name="category_id"
                                                                        id="category_id">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-12 col-sm-12 col-xs-12">
                                                            <div class="form-group">
                                                                ...
                                                                <select id="age"
                                                                        class="form-control disabledDiv @error('age') is-invalid @enderror"
                                                                        name="age"
                                                                        autocomplete="age">
