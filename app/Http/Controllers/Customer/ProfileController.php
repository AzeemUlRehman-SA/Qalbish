...
class ProfileController extends Controller
{
    ...
    public function index()
    {
        ...
        $user = auth()->user();
        $category_name = Service::where('id', $user->category_id)->first()->name;
        return view('customer.profiles.index', compact('user','category_name'));
    }
    ...
    public function editProfile()
    {
        ...
        $cities = City::all();
        $areas = Area::all();
        return view('customer.profiles.edit-profile', compact('user', 'categories', 'cities', 'areas'));
    }
    ...
    public function changePassword()
    {
        ...
        return view('customer.profiles.change-password', compact('user'));
    }
    ...
    public function changeMobileNumber()
    {
        ...
        $user = auth()->user();
        return view('customer.profiles.change-mobile-number', compact('user'));
    }
